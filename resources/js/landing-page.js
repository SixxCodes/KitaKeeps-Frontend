        ...
        return {
            ...
            team: [
                { image: 'assets/images/team/merry-cat.jpg', 
                    ...
                    role: 'Database Manager / Documentation Specialist', 
                    description: 'Manages data systems for accuracy and accessibility while designing intuitive, user-friendly interfaces for a seamless experience.' },
                { image: 'assets/images/team/kenny-cat.jpg', 
                    name: 'Zyrile Kenny C. Madayag', 
                    role: 'Project Manager / UI/UX Designer / Full-Stack Developer', 
                    description: 'Oversees project planning and execution while developing both frontend and backend systems for a complete, functional solution.' },
                { image: 'assets/images/team/vien-cat.jpg', 
                    name: 'Vien Justine E. Ugay', 
                    role: 'Researcher / Documentation Specialist / UI/UX Designer', 
...
const el = document.getElementById('landing-page-app');
if (el) {
    app.mount('#landing-page-app');
}