...
<x-modal name="edit-supplier" :show="false" maxWidth="lg">
    <div class="p-6 overflow-y-auto max-h-[80vh] table-pretty-scrollbar">
        ...
        <div class="flex justify-between mb-4 space-x-1 text-blue-900">
            ...
            <span x-on:click="$dispatch('close-modal', 'edit-supplier')" class="cursor-pointer">
        ...
        <div class="space-y-4 text-sm">
            ...
            <div class="flex flex-col items-center mb-6">
                <div class="relative">
                    ...
                    <input type="file" name="supp_image" class="hidden">
                </div>
            ...
            <fieldset class="p-4 border border-gray-200 rounded-lg">
                ...
                <div class="grid grid-cols-1 gap-4 mt-2 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        <label class="block mb-1 text-gray-800">Supplier Name</label>
                        <input type="text" name="supp_name" value="Supplier Name" class="w-full px-2 py-1 border border-gray-300 rounded focus:ring-1 focus:ring-green-500 focus:border-green-500"/>
                    </div>

                    <!-- Contact Number -->
                    <div class="sm:col-span-2">
                        <label class="block mb-1 text-gray-800">Contact Number</label>
                        <input type="text" name="supp_contact" value="09262811138" class="w-full px-2 py-1 border border-gray-300 rounded focus:ring-1 focus:ring-green-500 focus:border-green-500"/>
                    </div>

                    <!-- Address -->
                    <div class="sm:col-span-2">
                        <label class="block mb-1 text-gray-800">Address</label>
                        <input type="text" name="supp_address" value="Address of Supplier, DDO" class="w-full px-2 py-1 border border-gray-300 rounded focus:ring-1 focus:ring-green-500 focus:border-green-500"/>
                    </div>
                </div>
            </fieldset>
            ...
            <!-- Buttons -->
            <div class="flex justify-end mt-2 space-x-2">
                <button type="button" x-on:click="$dispatch('close-modal', 'edit-supplier')"
                    class="px-3 py-1 text-gray-700 transition bg-gray-200 rounded hover:bg-gray-300">Cancel
                </button>

                <button x-on:click="$dispatch('open-modal', 'success-modal')" class="px-3 py-1 text-white transition bg-green-600 rounded hover:bg-green-700">Update</button>
            </div>
        </div>
    </div>
</x-modal>
